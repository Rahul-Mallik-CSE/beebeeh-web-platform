    ...
    <div className="bg-white">
      ...
      <div className="border border-gray-200 rounded-2xl p-3 sm:p-4 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="border-2 border-dashed border-gray-300 rounded-lg h-14 sm:h-16 flex items-center justify-center ">
              {signatureImage ? (
                <Image
                  src={signatureImage}
            ...
            <Button
              ...
              className="w-full bg-[#5C3D2E] hover:bg-[#4A2F22] text-white text-sm sm:text-base rounded-lg py-2 sm:py-2.5"
            >
              Collect
            </Button>
          </div>
