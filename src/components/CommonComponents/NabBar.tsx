...
const NavBar = () => {
  return (
    <div className="w-full sticky top-0 z-50">
      <div className=" max-w-[2500px] rounded-2xl mx-auto flex items-center justify-between bg-white border-b border-gray-200 px-6 py-3">
        {/* Left side - Title */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search"
              className="pl-10 pr-4 py-2 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-800 w-64"
            />
          </div>
