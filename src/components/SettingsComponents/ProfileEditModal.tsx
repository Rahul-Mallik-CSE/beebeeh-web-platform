...
const ProfileEditModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] bg-white mx-4">
        ...
        <div className="space-y-4 sm:space-y-6 py-3 sm:py-4">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <button className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-gray-50 transition-colors">
